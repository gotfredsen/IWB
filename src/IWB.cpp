...
// uint8_t SPL_CHIP_ADDRESS = 0x76;  //Uncomment this line if SDO= Pulled to gnd: ADDRESS 0x76
uint8_t SPL_CHIP_ADDRESS = 0x77;  // Uncomment this line if SDO= Pulled HIGH: ADDRESS 0x77
